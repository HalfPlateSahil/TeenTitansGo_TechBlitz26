...
import { hasRedisConfig, hasSmtpConfig, hasSupabaseConfig, hasTelegramConfig } from "./config/env.js";
...
async function bootstrap() {
  ...
  const leadService = new LeadService(repository, aiClient, notificationGateway, emailGateway, followUpScheduler);
